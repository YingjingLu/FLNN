...
class L0_Cifar( object ):
    ...
    def construct_clf( self ):
        ...
        with tf.variable_scope( "nn" ) as scope:
            ...
            self.logit_train, _, self.final_w, _ =  dense( self.net_l1_train, 2, initializer = tf.random_normal_initializer( stddev = 1./tf.sqrt( 2./2. ) ), name = "logit" )
            self.logit_test, _, _, _ =  dense( self.net_l1_test, 2, initializer = tf.random_normal_initializer( stddev = 1./tf.sqrt( 2./2. ) ), name = "logit", reuse = True )
